class AdvertiserPromoNumberBulkBuster < Buster
  ...
  def create_advertiser_promo_numbers(api_token)
    ...
    promo_numbers.each do |promo_number|
      this = Invoca::AdvertiserCampaign.new(self.network_id.to_s, promo_number[:advertiser_id_from_network], promo_number[:advertiser_campaign_id_from_network], api_token)
